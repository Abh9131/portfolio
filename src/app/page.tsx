    ...
    <section id="certifications" className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          ...
          text="Covers AI foundations, GenAI, data analysis, Python, Excel, and a bit of industrial IoT."
        />
          ...
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-300">
                A few of my pinned repos - document verification, a multi-agent research assistant,
                a LangChain chatbot, NLP classification, and time-series forecasting. Check the READMEs
        ...
        <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="rounded-3xl border border-slate-200 bg-white/75 p-6 shadow-soft backdrop-blur dark:border-white/10 dark:bg-white/[0.06]">
            ...
            <p className="mt-3 leading-7 text-slate-600 dark:text-slate-300">
              I'm looking at AI/ML engineering, data analytics, LLM application development, and
              agentic AI roles - anywhere I can actually ship things, not just prototype them.
            </p>
