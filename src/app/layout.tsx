...
export const metadata: Metadata = {
  metadataBase: new URL("https://abhishek9131-portfolio.vercel.app"),
  title: {
  ...
  openGraph: {
    ...
    description:
      "AI, ML, GenAI, and data analytics portfolio with projects in document verification, agentic AI, chatbots, NLP, and forecasting.",
    url: "https://abhishek9131-portfolio.vercel.app",
